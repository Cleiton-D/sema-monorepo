...
public class ClassesBuilder<T> {
  private Map<String, Object> params = new HashMap<String, Object>();
  private List<T> list = new ArrayList<T>();

  public ClassesBuilder<T> setList(List<T> list) {
    this.list = list;
    return this;
  }

  public ClassesBuilder<T> addItem(T item) {
    this.list.add(item);
    return this;
  }

  public ClassesBuilder<T> setParam(String key, Object value) {
