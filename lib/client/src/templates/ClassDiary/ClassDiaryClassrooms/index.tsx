...
import PrintClassDiaryModal, {
  PrintClassDiaryModalRef
} from 'components/PrintClassDiaryModal';
...
const ClassDiaryClassrooms = () => {
  const [filters, setFilters] =
    useState<ListClassroomsFilters>(INITIAL_FILTERS);

  const modalRef = useRef<PrintClassDiaryModalRef>(null);
  ...
  return (
    <Base>
      <Heading>Diário de classe - selecione uma turma</Heading>
      ...
      <PrintClassDiaryModal ref={modalRef} />
    </Base>
  );
};

export default ClassDiaryClassrooms;
